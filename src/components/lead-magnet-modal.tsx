    ...
    <>
      ...
      <div className="fixed inset-0 z-[101] overflow-y-auto">
        <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
          <div 
            className="relative bg-gradient-to-br from-[#fffdf9] to-[#f8f6f2] rounded-2xl shadow-2xl max-w-2xl w-full p-8 overflow-hidden transform transition-all"
          ...
          >
            ...
            <div className="text-center mb-10">
              <h2 className="text-4xl font-bold text-[#2a7c60] mb-4 leading-tight">
                Guía Práctica: Automatiza tu Empresa con IA
              </h2>
