...
import { toast } from "sonner"; // Si tienes sonner instalado
...
export default function ImageUpload({ onImageUpload, initialImageUrl }: ImageUploadProps) {
  ...
  // Función para manejar toast si no está disponible
        ...
        <div className="space-y-2">
          <button
            ...
            onClick={() => {
              setPreviewUrl(null);
              onImageUpload('');
              console.log("ImageUpload: Imagen eliminada, URL limpiada");
            }}
