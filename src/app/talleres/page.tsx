...
const formatearFecha = (fechaISO?: string, tipo?: string) => {
  ...
  return (
    <div className="min-h-screen bg-[#f8f5f0]">
        ...
        <div className="container mx-auto w-[65%]">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center mt-10 space-y-4 md:space-y-0 md:space-x-8">
            <div className="text-center">
              ...
              <div className="text-sm">Mejora tu productividad</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold">+300</div>
              <div className="text-sm">Profesionales capacitados</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="bg-[#1b5e4f] text-white py-8 px-6 md:px-12">
